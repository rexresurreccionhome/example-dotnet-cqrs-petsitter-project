...
namespace Query.Sitter.Infrastructure.Converter;
...
public class EventJsonConverter : JsonConverter<BaseEvent>
{
    ...
    public override BaseEvent? Read(ref Utf8JsonReader reader, Type typeToConvert, JsonSerializerOptions options)
    {
        ...
        {
            nameof(SitterCreatedEvent) => JsonSerializer.Deserialize<SitterCreatedEvent>(json, options),
            nameof(SitterUpdatedEvent) => JsonSerializer.Deserialize<SitterUpdatedEvent>(json, options),
